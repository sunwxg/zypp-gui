...
impl Notification {
    pub fn new(builder: &gtk::Builder) -> Self {
        let notification_bar: gtk::Revealer = builder.get_object("notification_bar").unwrap();
        let label: gtk::Label = builder.get_object("notification_label").unwrap();
    ...
    fn signal_connect(builder: &gtk::Builder) {
        let button: gtk::Button = builder.get_object("notification_button").unwrap();
        let notification_bar: gtk::Revealer = builder.get_object("notification_bar").unwrap();
